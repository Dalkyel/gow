...
const nodes = [
    ...
    },
    {
        ...
        desc: 'El arma icónica de Kratos en God of War (2018). Hacha enorme imbuida con magia de hielo/frost, forjada por los enanos Brok y Sindri originalmente para Faye, y heredada por Kratos. La transporta atada a una eslinga en la espalda. Su mecánica de combate: carga de escarcha mediante comando silencioso (mental, sin palabra ni gesto visible), lanzamiento con precisión devastadora, y retorno al cerrar la palma abierta — «mágicamente vinculada a él, respondiendo sin dudar». Cuando se usa por primera vez frente al troll: el hacha atraviesa el cuerpo del ciervo muerto que el troll usaba como escudo, congelándolo instantáneamente; el cadáver se hace añicos al tocar el suelo. El troll codicia el arma en cuanto la ve y agarra su mango para inmovilizar a Kratos. Después del combate Kratos la limpia y vuelve a colocarla en su eslinga con movimientos deliberados. Es el reemplazo funcional de las Blades of Chaos de la saga griega — con la diferencia fundamental de que el hacha fue un regalo de amor (Faye la comisionó) y no una cadena de esclavitud (las Blades fueron impuestas por Ares).',
        star: '★★★ La primera vez que Kratos usa el hacha no es para atacar: es para arrebatar el ciervo al troll. El instinto protector — no el combativo — desencadena el arma. El troll la codicia, lo que confirma que cualquier ser poderoso en este mundo reconocerá lo que Kratos porta. La eslinga en la espalda durante la cacería era la frontera entre ser padre y ser dios; cruzarla marca el inicio del viaje real.'
    },
    {
    ...
    // ── PERSONAJES NUEVOS ──────────────────────────────
    {
        ...
        desc: 'Figura que irrumpe en los terrenos del hogar de Kratos al amanecer del día posterior a la caza. Antecedentes de su llegada: se oye el crujido violento de ramas abriéndose paso hacia la casa; el aleteo de alas coriáceas enormes tomando vuelo; un chillido antinatural que ripple el aire; más ramas partiéndose bajo gran peso. Llega a la puerta con golpes atronadores que hacen vibrar los maderos — Atreus lo imagina como un gigante de nueve metros. Voz: áspera, rasposa y casual, lo que lo hace más inquietante. Sus palabras exactas: «¡Sal! No tiene sentido seguir escondiéndote. Sé quién eres. Y lo que es más importante, ¡sé lo que eres!» Kratos siente sus palabras deslizarse bajo su piel. Oculta a Atreus en el espacio bajo la trampa del suelo antes de abrir la puerta — sin el hacha, por decisión: «El viejo Kratos lo habría hecho. El nuevo Kratos decidió no hacerlo», esperando desescalar antes de escalar.',
        star: '★★★ El Desconocido sabe lo que Kratos es — un dios extranjero que debería ser invisible en este mundo. La llegada va precedida de alas coriáceas y un chillido antinatural: señales de algo que no es simplemente humano ni simplemente una bestia. La decisión de Kratos de abrir la puerta sin el hacha es su elección más reveladora hasta ahora: el padre razona antes de que el dios actúe. Es la primera prueba real de cuánto ha cambiado.'
    },
    {
    ...
    {
        id: 'llegada-desconocido', label: 'Llegada del Desconocido', group: 'EVENTO', type: 'Evento — Cliffhanger',
        desc: 'A la mañana siguiente, mientras padre e hijo debaten el veredicto, el bosque interrumpe: crujido violento de ramas apartándose, escalando en un golpe sordo — algo grande despejando un camino hacia la casa. El miedo cierra la garganta de Atreus. Kratos toma el hacha y calcula el tiempo para proteger a su hijo. Atreus pregunta qué fue eso — Kratos: «Silencio.» Alas coriáceas enormes despegan ruidosamente; un chillido antinatural ripple el aire; más ramas partiéndose bajo gran peso. Ninguno se mueve. Ninguno respira. Entonces: golpes atronadores en la puerta que sacuden los maderos. «¡Sal! No tiene sentido seguir escondiéndote. Sé quién eres. Y lo que es más importante, ¡sé lo que eres!» — voz áspera, rasposa, casual. Nuevos golpes insistentes. Kratos esconde a Atreus en el espacio bajo la trampa del suelo (ver nodo trampa-suelo), asegura la puerta con un travesaño y luego — decide no sacar el hacha. Abre la puerta.',
        star: '★★★ El Desconocido llega precedido de alas coriáceas y un chillido antinatural: no es humano ordinario, no es bestia ordinaria. «Sé lo que eres» es la frase más amenazante posible para un dios que lleva años intentando ser invisible. La decisión de Kratos de no empuñar el hacha es el mayor acto de cambio del personaje hasta ahora: el padre razona, el dios espera.'
    },
