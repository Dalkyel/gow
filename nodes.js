...
const nodes = [
    ...
    {
        id: 'cat-trama', label: 'Trama', group: 'CAT', type: 'Categoría',
    ...
    },
    {
        ...
        desc: '«Solo dispara cuando yo te diga que dispares.» / «No te disculpes. Sé mejor.» / «Demorar lo que debe hacerse solo invita al problema.» / «La ira puede ser un arma... si la controlas, si la usas a tu ventaja. Tú claramente no puedes.» Kratos enseña con aforismos duros pero funcionales: la precisión sobre el entusiasmo, la acción sin demora, la brutalidad como misericordia. Su doctrina de la ira es la que distingue al guerrero del berserker: no niega la ira — la convierte en herramienta dirigida. Cuando Atreus protesta que Kratos también se enoja en combate, Kratos confirma que la diferencia no es sentir sino controlar. Su pedagogía contrasta con la de Faye, que era alentadora e iterativa. Kratos no enseña cómo sentirse — enseña cómo actuar.',
        star: '★★★ «La ira puede ser un arma» es la máxima más importante del capítulo 3: Kratos no pide a Atreus que suprima la ira como suprimió la compasión ante el ciervo — le pide que la discipline. Es una distinción crucial que el niño todavía no puede encarnar, pero que define el estándar hacia el que el viaje lo empujará.'
    },
    {
    ...
    {
        id: 'ataque-troll', label: 'Ataque del Troll del Bosque', group: 'EVENTO', type: 'Evento — Apertura del Combate',
        desc: 'Mientras Kratos y Atreus observan el cuerpo quieto del ciervo, el sotobosque a una docena de pasos explota. Un troll del bosque emerge: tres veces la altura de Kratos, cuatro veces su volumen, mano gris colosal golpeando la cresta, boca enmarcada por colmillos defensivos curvados. Atraído por el olor de la sangre. Kratos reacciona: «Troll del bosque. Quédate detrás de mí.» Antes de que pueda colocar a Atreus a salvo, el troll lanza un puño colosal al pecho del Dios de la Guerra, enviando a ambos rodando hacia un hueco entre los árboles. El troll agarra el cadáver del ciervo con la otra mano. Inicio del combate.',
        star: '★★ El instinto inmediato de Kratos es proteger a Atreus antes de atacar. El troll llega con hambre, no con malicia — pero su tamaño y su lenguaje lo convierten en el primer adversario real de la historia, irreducible a lección de caza.'
    },
    ...
    },
    {
        ...
        desc: '¿Puede un dios de la guerra convertirse en padre? ¿Puede un hijo de la guerra escapar a la violencia? Plantea la pregunta a través de la cacería: matar no es abstracto — es una habilidad que se enseña, se aprende y se siente. La compasión de Atreus ante el ciervo sugiere que no hereda automáticamente la frialdad de Kratos. Pero su brazo tiembla — tiene el impulso de actuar; le falta la disociación. La filosofía de Kratos («es simplemente un objetivo, vacía tu mente») es una técnica de supervivencia, no de deshumanización. La novela investiga si Atreus puede aprender la técnica sin perder el corazón.',
    ...
    },
    {
        ...
        desc: 'Revelación central de la obra (spoiler): Atreus es Loki, el dios nórdico del caos, hijo de Kratos/Farbauti y Faye/Laufey. Su verdadero nombre nórdico, Loki, le es revelado al final del juego. Este es el giro que recontextualiza toda la narrativa: el «niño de la cacería» es en realidad una figura mítica fundamental cuya existencia cambiará el destino de todos los Nueve Reinos. No hay indicios explícitos de esto — pero el texto siembra su carácter empático y curioso como contrapeso al de su padre.',
        star: '★★★ El mayor twist narrativo de la saga. La novelización lo maneja con sutileza: la compasión de Atreus no es una debilidad que debe corregirse — es el germen del caos ordenado que Loki representa en la mitología. La pregunta de si Kratos puede cambiar se invierte: ¿puede Atreus no convertirse en lo que la mitología dijo que sería?'
    },
    ...
    // ── DIOSES ─────────────────────────────────────────
    {
        ...
        star: '★★★ Odín es el gran ausente pero la sombra bajo la que todo sucede. Cada troll que aparece, cada gigante muerto, cada reino cerrado: todo es consecuencia de sus decisiones. Comprenderlo es comprender el mundo en que Kratos y Atreus se mueven. En el juego su presencia se siente antes de que aparezca: su mano está en todo.'
    },
    {
    ...
    },
    {
        ...
        star: '★★★ Fimbulwinter actúa en la narrativa de GoW como un reloj que alguien adelantó sin permiso. La pregunta de qué lo desencadenó y cuándo comenzará es parte del suspenso que se construye a lo largo de la historia. El bosque nevado ya lleva en sí la semilla del invierno interminable que viene.'
    },
    ...
    },
    {
        ...
        star: '★★★ La guerra Æsir-Vanir es el pasado que explica el presente: por qué Freya está en Midgard, por qué Mimir está prisionero de Odín, por qué los enanos cargan culpa, por qué los Vanir no son libres. Es la capa histórica que precede al estado del mundo.'
    },
    ...
    },
    {
        ...
        desc: 'El arma icónica de Kratos, forjada por los enanos Brok y Sindri originalmente para Faye. Transportada en eslinga en la espalda. Mecánica: carga de escarcha mediante comando mental silencioso, lanzamiento con precisión, retorno al cerrar la palma abierta. En el combate con el troll: congela el ciervo instantáneamente al penetrar su piel — el cadáver se hace añicos al tocar el suelo. En el combate con el Desconocido: el hacha se embebe en su pecho con fuerza máxima de escarcha cargada — pero el Desconocido NO SE CONGELA. Es inmune al poder de escarcha. La herida se cierra sola en segundos. La acción de Kratos de llamar el hacha de vuelta es lo que hace caer al Desconocido al suelo — la extracción forzada, no la herida. Esta inmunidad redefine el nivel de amenaza: ninguna de las armas conocidas de Kratos puede herir de forma duradera a este ser.',
        star: '★★★ La inmunidad al frost del hacha es la mayor revelación táctica del capítulo. Kratos construyó todo su sistema de combate en torno a esta arma — y el primer ser verdaderamente peligroso que encuentra la hace irrelevante. La obra establece así que el viaje que viene exigirá algo más que el hacha.'
    },
    {
        id: 'leviathan-magic', label: 'Magia de Gáldr (Runas)', group: 'VIDEOJUEGO', type: 'Lore — Sistema Mágico',
        desc: 'En el mundo de God of War la magia opera a través del Gáldr: cantos rúnicos, encantamientos y el poder inscrito en los objetos y el entorno. Las runas del Hacha de Leviatán son el sistema de habilidades del jugador en el juego (runic attacks). No hay magia explícita — pero el bosque de Midgard en la mitología está imbuido de Seiðr (magia de Faye era presumiblemente de esta escuela). Nodo a expandir en capítulos posteriores.',
        star: ''
    },
    {
        id: 'novelizacion', label: 'Novelización Oficial', group: 'VIDEOJUEGO', type: 'Obra — Novela',
        desc: 'Adaptación literaria oficial del videojuego God of War (2018), escrita por J.M. Barlog (relacionado con el director Cory Barlog). La novelización amplía el texto del videojuego con acceso a la voz interior de los personajes — en especial de Atreus — y con detalles sensoriales y psicológicos que el medio interactivo no puede transmitir directamente. Corresponde aproximadamente a la secuencia de apertura del juego.',
    ...
    {
        id: 'combate-troll-completo', label: 'Combate con el Troll', group: 'EVENTO', type: 'Evento — Secuencia de Combate',
        desc: 'Secuencia completa del primer combate. (1) PRIMER CONTACTO: el troll golpea el pecho de Kratos como a un muñeco de trapo, tira el hacha al suelo. El troll ríe ante el esfuerzo «humano». (2) RETORNO DEL HACHA: el hacha vuelve a la mano de Kratos — el troll no comprende. Ahora codicia el arma y agarra su mango para inmovilizar al dios. (3) ATREUS INTENTA DISPARAR: se pone en pie, arco en mano, busca un ángulo limpio al pecho del troll. Kratos: «¡No dispares!» — la orden en medio del forcejeo. Atreus obedece, anulando la punta hacia arriba. Kratos golpea la mandíbula del troll con el puño libre, retrocediéndolo unos pasos. El troll ha subestimado seriamente la fuerza del hombre. (4) KRATOS EN EL SUELO: el troll carga y aplasta a Kratos contra la tierra, sonriendo con malicia. Levanta el canto rodado más cercano apuntándolo a Atreus. «¡Muchacho!» — Atreus responde: «Estoy bien. ¡Mátalo!» Apunta al centro del pecho del troll — «el blanco más fácil es el más grande» — pero antes de poder exhalar, el troll carga sobre Kratos. (5) MUERTE DEL TROLL: Kratos golpea la garganta del troll obligándolo a retroceder. Salta, lanza el hacha hacia arriba clavándola en el hombro. El troll ulula, se tambalea. En el momento en que el troll intenta aferrar el cuello de Kratos, Kratos sube el hacha y le hiende la cabeza. El troll cae de bruces en la tierra.',
        star: '★★★ El combate establece la dinámica de cooperación padre-hijo que regirá la obra: Atreus quiere actuar, Kratos lo frena, Atreus necesita saber cuándo desobedecer y cuándo no. La diferencia con la cacería: ahora Kratos no frena su ira — la enfoca. Cada fase del combate demuestra que el «padre» y el «dios» coexisten, y que el mundo nórdico los va a necesitar a ambos.'
    },
    {
    ...
    {
        id: 'llegada-desconocido', label: 'Llegada del Desconocido', group: 'EVENTO', type: 'Evento — Apertura del Combate',
        desc: 'A la mañana siguiente, mientras padre e hijo debaten el veredicto, el bosque interrumpe: crujido violento de ramas, golpe sordo, alas coriáceas despegando, chillido antinatural, más ramas partiéndose. Golpes atronadores en la puerta. Voz áspera: «¡Sal! Sé quién eres. Y lo que es más importante, ¡sé lo que eres!» Kratos esconde a Atreus bajo la trampa del suelo, asegura la puerta con el travesaño y — decide no empuñar el hacha. Sale. El Desconocido lo evalúa, lo desafía verbalmente («cobarde patético que se esconde»), avanza tres pasos hasta quedar al alcance de Kratos y le da una bofetada. Kratos absorbe el golpe, recuerda su voto y se fuerza a no reaccionar. El fuego le nace en los ojos. El Desconocido insiste: «Tendrás que matarme para que eso ocurra.» Da una serie de puñetazos salvajes — Kratos atrapa el cuarto. «Te avisé.» Y comienza el combate.',
        star: '★★★ La bofetada es el desencadenante narrativo más preciso del capítulo: es un insulto calculado, no un golpe en serio. El Desconocido quiere que Kratos ataque. Que Kratos la absorba primero — sosteniendo el voto — es su victoria moral antes de perder la física.'
    },
...

    {
        ...
        desc: 'Secuencia completa del combate entre Kratos y el Desconocido. (1) PROVOCACIÓN: el Desconocido avanza tres pasos hasta quedar al alcance de Kratos y le da una bofetada calculada. Kratos absorbe el golpe, recuerda el voto, se fuerza a no reaccionar. El Desconocido: «Tendrás que matarme para que eso suceda.» Serie de puñetazos salvajes — Kratos atrapa el cuarto: «Te avisé.» (2) PRIMERA FASE — GOLPE AÉREO: el Desconocido suelta un uppercut que envía a Kratos volando por el aire, lo salta sobre el tejado de la casa. Kratos rueda, se planta, carga — el Desconocido usa su peso contra él y lo estrella en un lateral de la casa. (3) SEGUNDA FASE — TEJADO: el Desconocido lo agarra como a un muñeco de trapo, salta alto y lo estrella en el alero del tejado. A horcajadas sobre Kratos, lluvia de golpes aturdidores. Mientras mira por el agujero del techo: «¿Por qué hay dos camas?» Kratos le golpea la mandíbula expuesta y lo tira del tejado. (4) HACHA — INMUNIDAD: el Desconocido lanza un peñasco enorme. Kratos lanza el hacha cargada de escarcha con toda la fuerza — se clava en el pecho del Desconocido. No se congela. La herida se cierra en segundos. Kratos le agarra la garganta y lo levanta del suelo. (5) MONOLITO Y GRIETA: Kratos arrastra al Desconocido con un tronco arrancado, lo embiste, terminan junto a un monolito tallado colosal. Kratos lo vuelca sobre el Desconocido, aplastándolo. Pausa. El monolito truena — el Desconocido lo levanta sobre la cabeza con una sonrisa. «¿Odín me envió por respuestas, pero tu vanidad lo convirtió en batalla.» Se arrojan el monolito mutuamente en vuelo. Colisión en campo abierto — la tierra cede bajo ellos y caen a una grieta. (6) REVELACIÓN Y FIN: «No puedo sentir nada de esto» — ríe. Uppercut desde la grieta lanza a Kratos arriba. El Desconocido lo pisotea y lo patea al fondo de la grieta. Kratos emerge con brazos temblorosos, asume postura de combate. Carga, gira al Desconocido, lo inmoviliza en llave de cuello inversa, gira con toda la fuerza hasta romperle el cuello. El cuerpo colapsa. Kratos lo arroja a la grieta. Espera minutos — no vuelve.',
        star: '★★★ El combate más largo y destructivo de la obra hasta ahora. Físicamente redefine el mundo: si este ser — enviado por Odín — puede igualar y superar a Kratos, el nivel de amenaza del cosmos nórdico es de otro orden. La estructura del combate (provocación → absorción del golpe → escalada inevitable) es un espejo de la pedagogía de Kratos: resistir hasta que ya no se puede resistir.'
    },
    {
    ...
    {
        id: 'inmunidad-desconocido', label: 'Poderes del Desconocido', group: 'KRATOS', type: 'Rasgo — Poderes',
        desc: 'Capacidades reveladas en combate: (1) FUERZA SOBREHUMANA: un solo uppercut envía a Kratos volando por el aire; levanta un monolito tallado mayor que él mismo y lo arroja; soporta los golpes más brutales de Kratos sin perder control de sus extremidades. (2) INMUNIDAD AL FROST: el Hacha de Leviatán cargada al máximo lo clava en el pecho — no se congela. Ningún otro ser hasta ahora ha resistido la escarcha. (3) REGENERACIÓN INSTANTÁNEA: la herida del hacha se cierra en segundos. No sangra. No se magulla después de golpes devastadores. (4) AUSENCIA DE DOLOR: «No puedo sentir nada de esto» — lo declara y lo demuestra. Le rompen el cuello y el cuerpo colapsa, pero la anticipación de Kratos de que podría levantarse aun así es coherente con todo lo anterior. (5) CONOCIMIENTO: sabe que Kratos es un dios extranjero, sabe su pasado, lo encontró en Midgard donde lleva años intentando ser invisible.',
        star: '★★★ La combinación inmunidad al frost + regeneración + ausencia de dolor crea una amenaza que ninguna de las armas de Kratos puede resolver de forma permanente. El cuello roto y el cuerpo en la grieta son una victoria táctica muy provisional — el texto lo subraya dejando a Kratos esperando minutos por si el Desconocido vuelve a levantarse.'
    },
    {
